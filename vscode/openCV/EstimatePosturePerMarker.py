...
def process_image(QueryImg):
    ...
    if ids is not None and len(ids) > 0:
        ...
        for i in range(0, len(ids)):
            ...
            QueryImg = aruco.drawAxis(QueryImg, cameraMatrix, distCoeffs, rvec, tvec, 0.011)
        # Display our image
...
# process_video('./openCV/20230816_100847.mp4')
img = cv2.imread("./openCV/Calibration/20230816_084003.jpg")
process_image(img)
