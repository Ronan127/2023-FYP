...
assignment_gears = [separation35 == 0.041; separation23 == 0.07; rw == 0.075; l7_ab == 0.425;
    N_idler == 33; N_sun == 50; N_planet == 16; C_friction7 == 0.2;];
...
assignmnent_masses = [m7 == 0.43095538;
    m2 == 2*0.056167152496905625725;
    m1 == 2*0.13271340229034475633;
    m3 == 2*0.018874380082186052732;
    m4 == m3;
...
assignment_gears = [separation35 == 0.041; separation23 == 0.07; rw == 0.075; l7_ab == 0.725;
    N_idler == 33; N_sun == 50; N_planet == 16; C_friction7 == 0.2;];


DesignParameters = [assignmnent_g; assignmnent_masses; assignment_inertias; assignment_gears; assignment_steps];

save DesignParametersExtraTail.mat DesignParameters assignmnent_g assignmnent_masses assignment_inertias assignment_gears assignment_steps