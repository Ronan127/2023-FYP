...
\include{chaps-proposal/Planned_activities}
\include{chaps-proposal/Risk_assessment}
\include{chaps-proposal/Conclusion}
%\include{chaps-main/chap-literature}
%\include{chaps-main/chap-content-A}
%\include{chaps-main/chap-conclusion}

\appendix%------------------------------------------------------------
\include{chaps-proposal/Planning_details}
\include{chaps-append/chap-ecsa}
\include{chaps-proposal/Resources}
