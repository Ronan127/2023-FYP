...
Figure \ref{fig:torque-comparison} shows that the model, simulation, and experiment all produce similar values. In Stages 1, 4, and 6, the model and simulation both produce a lower required torque than the device actually needs. In Stage 3, the device needs less torque to complete the motion than the model and simulation predict.\\
...
\begin{table}[!ht]
	...
	\begin{tabular}{|l|l|l|l|l|l|l|l|l|}
		...
		Simulation & -14.5\% & -6.8\% & 5.1\% & 23.1\% & -30.8\% & -5.6\% & -24.2\% & -23.1\% \\ \hline
	\end{tabular}
\end{table}
