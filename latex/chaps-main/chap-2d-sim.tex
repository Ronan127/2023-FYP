\chapter{Two-dimensional simulation}
...
%\begin{wrfigure}{r}{0.4\textwidth} %this figure will be at the left
%	\centering
%	\includegraphics[width=0.4\textwidth]{algo-case-wheel}
%	\caption{LIM climbing with wheel contact}
%	\label{algo-case-wheel}
%\end{wrfigure}
%
%\begin{wrapfigure}{r}{0.4\textwidth} %this figure will be at the left
%	\centering
%	\includegraphics[width=0.4\textwidth]{algo-case-frame}
%	\caption{LIM climbing with LIM frame contact}
...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{algo-case-wheel}
		\caption{Wheel contact}
		\label{algo-case-wheel}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{algo-case-frame}
...
\begin{wrapfigure}{r}{0.4\textwidth} %this figure will be at the left
	\centering
	\includegraphics[width=0.5\textwidth]{algo-case-body}
