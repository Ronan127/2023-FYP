...
\title{\textbf{Design, model and build a USAR robot platform}\\[2ex]
       \large Mechatronic Project 478\\Draft Report\\[2ex]}                   
...
\include{chaps-main/chap-2d-sim}
\include{chaps-main/chap-math-model}
\include{chaps-main/chap-design-requirements}
\include{chaps-main/chap-design}
\include{chaps-main/chap-drake-simulation}
\include{chaps-main/chap-experiment}
\include{chaps-main/chap-analysis}
\include{chaps-main/chap-recommendations}
\include{chaps-main/chap-conclusion}

%\include{chaps-main/chap-design-1}
%\include{chaps-main/chap-motion}

%\include{chaps-main/chap-conclusion}

\appendix%------------------------------------------------------------
\include{chaps-append/chap-ecsa}
\include{chaps-append/chap-budget}
\include{chaps-append/chap-risk}
\include{chaps-append/chap-resources}
